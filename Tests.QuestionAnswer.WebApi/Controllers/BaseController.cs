...
namespace Tests.QuestionAnswer.WebApi.Controllers
{
    ...
    {
        private bool HasTokenProvided => Request.Headers.ContainsKey("Authorization") ||
        ...
        protected JwtSecurityToken? Token => HasTokenProvided ? JwtService.ParseTokenNullSafe(StringToken) : throw new Exception("User don't provided token");
